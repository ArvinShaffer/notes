...
## Build with CMake、Mingw in win7

参考001.build with CMake.md

# Getting Started

## Draw Test Harness

[Draw](https://old.opencascade.com/doc/occt-7.4.0/refman/html/class_draw.html) is a command interpreter based on TCL and a graphical system used for testing and demonstrating OCCT modeling libraries.

[Draw](https://old.opencascade.com/doc/occt-7.4.0/refman/html/class_draw.html) can be used interactively to create, display and modify objects such as curves, surfaces and topological shapes.

Scripts can be written to customize [Draw](https://old.opencascade.com/doc/occt-7.4.0/refman/html/class_draw.html) and perform tests. New types of objects and new commands can be added using C++ programming language.

可以编写脚本以自定义Draw并执行测试。 可以使用C ++编程语言添加新类型的对象和新命令。
...
zoom：缩放，pan：平移，topological：拓补结构
...
- 2.Type *pload MODELING VISUALIZATION*
- 3.Type box b -10 -10 -10 20 20 20 to create a cube b of size 20, parallel to the X Y Z axis and centered on the origin. The cube will be displayed in the axonometric view in wireframe mode.

 axonometric：轴测图

![007_Draw_examples1_3.png](./occpics/007_Draw_examples1_3.png)

- 4.Type fit to fill the viewer with the cube

![008_Draw_examples1_4.png](./occpics/008_Draw_examples1_4.png)

- 5.Type pcylinder c 2 30 to create a cylinder c of radius 2 and height 30. The cylinder will be displayed in addition to the cube

![009_Draw_examples1_5.png](./occpics/009_Draw_examples1_5.png)
